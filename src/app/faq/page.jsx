  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-10">
      ...
      <section className="mt-8 divide-y divide-black/10">
        ...
        <div className="py-5">
          <h2 className="text-lg font-semibold">Can you book hotels and trains?</h2>
          <p className="mt-2 text-gray-700">
        ...
        <div className="py-5">
          <h2 className="text-lg font-semibold">Do you offer on-the-ground support?</h2>
          <p className="mt-2 text-gray-700">
        ...
        <div className="py-5">
          <h2 className="text-lg font-semibold">Is this suitable for families?</h2>
          <p className="mt-2 text-gray-700">
